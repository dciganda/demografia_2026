...
# 4to Laboratorio: Modelos del proceso reproductivo                            # 
...
# edad media a la union en el rango 18 - 25 y del coeficiente beta2
# en el rango -0.12 a 0.04 - Describir los resultados
